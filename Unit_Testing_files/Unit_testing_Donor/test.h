...
/* class for testing Donor Module */
class DonorTestCase : public CppUnit::TestCase // inheriting base class TestCase 
{
		CPPUNIT_TEST_SUITE(DonorTestCase); // to start the test suite definition
	...
	public:
		void testConstructor(); // testing constructor of Donor class for positive testcase
		void testConstructorcase1(); // testing constructor of Donor class for negative testcase
