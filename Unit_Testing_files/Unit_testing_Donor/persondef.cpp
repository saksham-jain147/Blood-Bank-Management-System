...
void Person :: display()
{
    cout<<"\nCustomer Id :: "<<get_Latest_Customer_Id();			
    cout<<"\nDonor Id :: "<<get_Latest_Donor_Id();
...
string Person :: get_Latest_Customer_Id()
{
	...
	ifstream in("customer_details.txt");			//Creating object for ifstream named in
...
string Person :: get_Latest_Donor_Id()
{
	...
	ifstream in("donor_details.txt");	//Creating object for ifstream named in
...
void Person :: append_Customer_Details()
{
	...
	out.open("customer_details.txt", ios::app);	//Opening file to append
	...
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	cout<<"\n\t\tWriting to a file for customer_details.txt is completed."<<endl;
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n\n";	
	...
	out1.open("customer_credential.txt", ios::app);		//Opening file to append
	...
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	cout<<"\n\t\tWriting to a file for customer_credential.txt is completed."<<endl;
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n\n";
...
void Person :: append_Donor_Details()
{
	...
	out.open("donor_details.txt", ios::app);	//Opening file to append
	if(!out.is_open())				//Checing for file existance
	{
		cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	...
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	cout<<"\n\t\tWriting to a file for donor_details.txt is completed."<<endl;
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n\n";
	...
	out1.open("donor_credential.txt", ios::app);	//Opening file to append
	if(!out1.is_open())				//Checing for file existance
	{
		cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	...
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n";
	cout<<"\n\t\tWriting to a file for donor_credential.txt is completed."<<endl;
	cout<<"\n---------------------------------------------------------------------------------------------------------------------\n\n";
