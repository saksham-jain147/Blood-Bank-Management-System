...
void Update_last_Name(Donor *d,list<list<string>> record,ofstream &out,string id,string name)
{
     ...
     { 
        ...
        d->writeFile(record,out);
        cout<<"\n\n:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n";
      	cout<<"\n\tYOUR LAST NAME IS UPDATED SUCCESSFULLY...\n";
      	cout<<"\n:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n";
}
...
void Donor :: update_donation_history(ifstream &in,string id,string bg,int quantity)
{
    ...
    in.close();
    in.open("text_files/donationhistory.txt",ios::app);
    ...
    if(quantity>0)
    {
		out.open("text_files/donationhistory.txt",ios::app);
...
void get_D::get_D_choice(string id)
{
     int choice;
     //cout<<"\nEnter id::  ";
     //  cin>>id;
     ...
     do
     {
         Display::display_D_menu();
         cout<<"\nENTER YOUR CHOICE :  ";
         cin>>choice;
         switch(choice)
         {
              case D_DISPLAY:  //to display personal details of Donor
              {
              		system("clear");
							
                    ifstream in;
                    in.open("text_files/donor_details.txt");
                    if(!in.is_open())
                    { 
                          cout<<"\n invalid text file";
                           exit(0);
              ...
              case D_DONATION:   // Make donation
              {
				   ...
				   in.close();
                   ofstream out;
                   out.open("text_files/donor_details.txt");
                  ...
                  // ofstream out;
                   ...
                   out.close();
                   //ifstream in;
                   in.open("text_files/donationhistory.txt");
                   d->update_donation_history(in,id,bg,quantity);
                   record.clear();
                   break;
              } 
                   
              case D_UPDATE:  //editing personal details
              {
              		system("clear");
                   ...
                   do
                   {
                       ...
                       switch(ch)
                       {
                            case D_F_NAME:  //updating first name
                            {
                            		system("clear");
							
                                 string updated_name;
                                 updated_name=d->Person :: firstname_validation();
                                 if(updated_name!="Invalid")
                                 {
                                 in.open("text_files/donor_details.txt");
                                 record=d->load_Data_into_list(in);
                                 in.close();
                            ...
                            case D_L_NAME:  //updating last name
                            {
                            		system("clear");
                            ...
                            case D_PHONENUMBER:  //updating phonenumber
                            {
                            	system("clear");
